...
if page == 'Restaurants':
    ...
    restaurant_locations = {
        ...
        'South Campus': [
            ...
            ("Main Street Market", "The Main Street Store is located inside Goodyear Dining Center on South Campus. The store carries a variety of beverages, snacks, and essential personal items.", "main_street_market.png"),
            # Add more restaurants and their details here
        ],
